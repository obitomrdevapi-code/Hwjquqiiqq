...
async function allHespress() {
  try {
    ...
    $(".col-12.col-sm-6.col-md-6.col-xl-3").each((_, element) => {
...
async function readHespress(url) {
  try {
    ...
    let image = $(".figure-heading-post.post-thumbnail img").attr("src") || $("meta[property='og:image']").attr("content");
...
module.exports = {
  ...
  description: "جلب جميع أخبار موقع Hespress أو تفاصيل خبر معين",
  router,
};